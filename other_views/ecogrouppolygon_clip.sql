...
SELECT group_cols, ecogroup, groupname, grouptype, pub_status, veg_type, area_ha, ecogrouparea_ha/area_ha AS ecogrouppct, ST_ForceRHR(ST_MakeValid(geom)) AS geom
