...
"""DROP TABLE IF EXISTS featline_shp;""",     
"""CREATE TABLE featline_shp (
	OBJECTID {oid},
	areasymbol {limit_text} (20),
	spatialver {double},
	featsym {limit_text} (3),
...
"""DROP TABLE IF EXISTS featpoint_shp;""",
"""CREATE TABLE featpoint_shp (
	OBJECTID {oid},
	areasymbol {limit_text} (20),
	spatialver {double},
	featsym {limit_text} (3),
...
"""DROP TABLE IF EXISTS muline_shp;""",
"""CREATE TABLE muline_shp (
	OBJECTID {oid},
	areasymbol {limit_text} (20),
	spatialver {double},
	musym {limit_text} (6),
...
"""DROP TABLE IF EXISTS mupoint_shp;""",
"""CREATE TABLE mupoint_shp (
	OBJECTID {oid},
	areasymbol {limit_text} (20),
	spatialver {double},
	musym {limit_text} (6),
...
"""DROP TABLE IF EXISTS mupolygon_shp;""",						  
"""CREATE TABLE mupolygon_shp (
	OBJECTID {oid},
	areasymbol {limit_text} (20),
	spatialver {double},
	musym {limit_text} (6),
...
"""DROP TABLE IF EXISTS sapolygon_shp;""",
"""CREATE TABLE sapolygon_shp (
	OBJECTID {oid},
	areasymbol {limit_text} (20),
	spatialver {double},
	lkey {limit_text} (30));""",
